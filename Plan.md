...
| Месяц       | `01` – `12`                                               | `00`, `13–99`, 1 цифра, буквы, пусто                             |
| Год         | Текущий год и следующие 5 лет (например, `25–30`)         | Год в прошлом (`23`), `00`, более чем +5 лет, буквы, спецсимволы |
...
3. Покупка с граничным CVC: 000
   
Шаги:

Перейти на форму "Купить".

Ввести карту: 4444 4444 4444 4441.

Ввести месяц: 09, год: 25.
...
Ожидаемый результат: Операция одобрена.

Проверка в БД:
payment_entity: status = APPROVED.

4. Имя владельца с дефисом
...
5. Имя владельца в нижнем регистре
...
Ожидание: Покупка проходит (если форма нечувствительна к регистру).
...
8. Максимально допустимый год: 30
...
9. Минимальный допустимый месяц: 01
...
10. Владелец с двойной фамилией
...
12. Покупка по отклонённой карте
...
13. Кредит по отклонённой карте
    
Шаги:

Открыть форму "Купить в кредит".

Ввести карту: 4444 4444 4444 4442.
